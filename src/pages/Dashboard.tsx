...
const Dashboard: React.FC = () => {
  ...
  const [treeData, setTreeData] =
    useState<ChapterWithTopicsAndProblems[]>([]);

  const [progressMap, setProgressMap] = useState<
    Map<string, 'not_started' | 'in_progress' | 'completed'>
  >(new Map());
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        // Fetch tree and progress concurrently
        ...
        setTreeData(treeRes);
        setProgressSummary(progressRes.data.summary); // { completed, inProgress, total, percentage }
        const progressList = progressRes.data.progress || [];
        const progressMapTmp = new Map<
          string,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600">
              Ready to track your DSA preparation? Here's your progress
              overview.
            </p>
          </section>
